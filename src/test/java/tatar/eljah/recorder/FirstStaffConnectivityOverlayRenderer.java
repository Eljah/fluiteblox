...
public class FirstStaffConnectivityOverlayRenderer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (NoteEvent n : topNotes) {
            ...
            paintVisited(out, above, above.connected ? new Color(90, 200, 120, 70) : new Color(240, 70, 70, 130));
            paintVisited(out, below, below.connected ? new Color(90, 200, 120, 70) : new Color(200, 70, 240, 130));
