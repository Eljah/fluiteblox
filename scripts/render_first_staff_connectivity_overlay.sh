...
java -cp "$OUT_DIR:$OPENCV_JAR" tatar.eljah.recorder.FirstStaffConnectivityOverlayRenderer "$ROOT/clear_sreenshot.png" "$ROOT/target/first_staff_connectivity_overlay.png"
